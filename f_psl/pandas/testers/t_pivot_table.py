from f_psl.pandas.generators.g_pivot_table import GenPivotTable
import pandas as pd
import numpy as np
...
def test_window_full_sum():
    ...
    ========================================================================
    """
    df = GenPivotTable.window_full_sum()
...
def test_window_full_mean() -> None:
    ...
    ========================================================================
    """
    df = GenPivotTable.window_full_mean()
...
def test_window_broken() -> None:
    ...
    ========================================================================
    """
    df = GenPivotTable.window_broken()
