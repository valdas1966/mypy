from f_graph.old_path.algos.algo import Problem
from f_graph.old_path.generators.g_graph import GenGraphPath as GenGraph, Graph
from f_graph.old_path.algos.many_to_one.generators.g_problem import GenProblemManyToOne as GenProblem
from f_graph.old_path.algos.many_to_one.algo import AlgoManyToOne
from f_graph.old_path.algos.one_to_many.algo import AlgoOneToMany, AlgoOneToOne
...
def experiments_to_csv() -> None:
    ...
    ========================================================================
    """
    df = pd.DataFrame(columns=['rows', 'old_nodes', 'pct_nodes', 'd_start_goal', 'h_start_goal', 'pct_start_goal',
...
def cross_maps_to_csv() -> None:
    ...
    ========================================================================
    """
    titles = ['i_1_map', 'rows', 'cols', 'old_nodes', 'pct_nodes', 'goals',
