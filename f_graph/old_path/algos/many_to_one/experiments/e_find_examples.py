from f_graph.old_path.algos.many_to_one.algo import AlgoManyToOne as Algo, TypeAlgo
from f_graph.old_path.algos.many_to_one.generators.g_problem import GenProblemManyToOne as GenProblem
from f_graph.old_path.algos.many_to_one.problem import ProblemManyToOne as Problem, Node
...
examples_top: tuple[Problem, int] = sorted(examples, key=lambda x: x[1],
                                           reverse=True)[:5]
# return example with the lowest difference in explored old_nodes
