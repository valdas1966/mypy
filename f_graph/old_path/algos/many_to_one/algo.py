from f_graph.old_path.algos.one_to_one.solution import SolutionOneToOne as Solution
...
from f_graph.old_path.algos.many_to_one.problem import ProblemManyToOne, Node
from f_graph.old_path.algos.many_to_one.solutions import SolutionsManyToOne as Solutions
...
class AlgoManyToOne(AlgoPath[ProblemManyToOne, Solutions]):
    ...
    def run(self) -> Solutions:
        ...
        for i, problem in enumerate(problems):
            ...
            # If old_path is not found, return invalid MTO Solution
            if not solution:
                return Solutions(is_valid=False, sols=sols)
            # If old_path is found and is shared:
            #  update the cache with old_nodes on the optimal old_path.
