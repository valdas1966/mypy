from f_graph.old_path.algos.one_to_one.state import StateOneToOne as State, Node
from f_graph.old_path.core.solution import SolutionPath, StatsPath
...
class SolutionOneToOne(SolutionPath[StatsPath]):
    ...
    def __init__(self,
        ...
        self._cache = cache
        self._state = state
        # The old_path was founded by the way
        if goal:
            stats = StatsPath()
    ...
    def path(self) -> Path:
        """
        ========================================================================
         Return the old_path of the solution.
        ========================================================================
        """
        return self._path
