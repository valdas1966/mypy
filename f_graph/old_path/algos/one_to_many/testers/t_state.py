from f_graph.old_path.algos.one_to_many.generators.g_state import GenStateOneToMany
...
def test_update() -> None:
    """
    ========================================================================
     Test that update() correctly updates heuristic of generated old_nodes.
    ========================================================================
    """
