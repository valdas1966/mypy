from f_graph.old_path.generators.g_path import GenPath, Path
from f_graph.old_path.generators.g_node import GenNode, Node
import pytest
...
def test_str(path: Path) -> None:
    """
    ========================================================================
     Test the string representation of the old_path.
    ========================================================================
    """
...
def test_key_comparison() -> None:
    """
    ========================================================================
     Test the key comparison of the old_path.
    ========================================================================
    """
    path_1 = GenPath.gen_first_row_3x3()
