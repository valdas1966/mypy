from f_graph.path.algos.many_to_one.algo import AlgoManyToOne as Algo, TypeAlgo
from f_graph.path.algos.many_to_one.generators.g_problem import GenProblemManyToOne as GenProblem
from f_graph.path.algos.many_to_one.problem import ProblemManyToOne as Problem, Node
