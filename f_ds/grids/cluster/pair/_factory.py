...
class Factory:
    ...
    def random(grid: GridMap,
        ...
        ========================================================================
         Sample two disjoint ClusterDiamonds on the grid such that:
           (a) len(A) >= min_cells_a, len(B) >= min_cells_b;
           (b) dist(A.center, B.center) >= min_distance;
           (c) A and B share no cells.
         Each diamond is built with its own Manhattan radius
         (steps_a, steps_b).
        ...
        raise ValueError(
            ...
            f'min_cells_b={min_cells_b}, '
            f'steps_a={steps_a}, steps_b={steps_b}, '
    ...
    def a() -> PairCluster[ClusterDiamond]:
        ...
        ========================================================================
         ...
         steps_a = steps_b = 1; center-distance = 10.
        ========================================================================
        """
