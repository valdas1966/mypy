...
class DataFrame(NDFrame, OpsMixin):
    ...
    def query(self, expr: str, *, inplace: bool = False, **kwargs) -> DataFrame | None:
        ...
        *Backtick quoted variables*
        ...
        questions mark, the exclamation mark, the dollar sign, and the euro sign.
    ...
    @doc(
        ...
        ...     {"Grade": ["A", "B", "A", "C"]},
        ...     index=[
        ...         ["Final exams", "Final exams", "Coursework", "Coursework"],
        ...
        >>> df.swaplevel(0)
                                            Grade
        January     History     Final exams      A
        February    Geography   Final exams      B
        ...
        >>> df.swaplevel(0, 1)
                                            Grade
        History     Final exams  January         A
        Geography   Final exams  February        B
