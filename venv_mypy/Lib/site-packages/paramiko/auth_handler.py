...
class AuthHandler:
    ...
    def _choose_fallback_pubkey_algorithm(self, key_type, my_algos):
        ...
        msg = "Server did not send a server-sig-algs list; defaulting to our first preferred algos ({!r})"  # noqa
...
""".format(
    ...
    def _parse_userauth_request(self, m):
        ...
        if method == "none":
            ...
            # NOTE: server never wants to guess a client's algos, they're
