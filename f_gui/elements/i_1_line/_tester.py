...
def test_endpoints() -> None:
    ...
    ========================================================================
    """
    line = Line(p1=Point(x=10, y=20), p2=Point(x=80, y=90))
...
def test_arrow() -> None:
    ...
    ========================================================================
    """
    line = Line(p1=Point(x=0, y=0), p2=Point(x=100, y=0), arrow=True)
...
def test_bounds_is_bbox() -> None:
    ...
    ========================================================================
    """
    line = Line(p1=Point(x=80, y=90), p2=Point(x=10, y=20))
