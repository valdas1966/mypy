"""
============================================================================
 KDijkstraMOSPP — counter pin on the canonical MOSPP problem
 ...
 totals to KBFSMOSPP on this uniform-cost map (Dijkstra's
...
def test_counters_canonical_mospp() -> None:
    """
    ========================================================================
     Pin KDijkstraMOSPP counters on the canonical MOSPP problem.
