"""
============================================================================
 KBFSMOSPP — counter pin on the canonical MOSPP problem
 (`grid_4x4_obstacle_mospp`: starts (0,3) / (3,0) / (3,3); goal
 (0,0); per-start optimal costs 7 / 3 / 6).

 KBFSMOSPP delegates to OMSPP `KBFS` via a flipped view (the
...
def test_counters_canonical_mospp() -> None:
    """
    ========================================================================
     Pin KBFSMOSPP counters on the canonical MOSPP problem.
