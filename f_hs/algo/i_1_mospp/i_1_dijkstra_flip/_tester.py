...
def test_kdijkstra_mospp_single_start() -> None:
    """
    ========================================================================
     k=1 behaves like a plain backward Dijkstra from the goal.
     One `on_start` event, no transitions.
    ========================================================================
    """
...
def test_kdijkstra_mospp_two_starts_both_expanded() -> None:
    """
    ========================================================================
     starts=[A, B], goal=C: single backward Dijkstra pass from
     C reaches B (g=1) then A (g=2). On-start events fire in
     g-order — B first, then A.
    ========================================================================
    """
...
def test_kdijkstra_mospp_unreachable_start() -> None:
    """
    ========================================================================
...
def test_kdijkstra_mospp_duplicate_start() -> None:
    """
    ========================================================================
...
def test_kdijkstra_mospp_reconstruct_path() -> None:
    """
    ========================================================================
