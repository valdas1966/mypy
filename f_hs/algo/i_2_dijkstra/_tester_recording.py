...
def test_counters_pin_grid_4x4_obstacle() -> None:
    """
    ========================================================================
     Pin the exact frontier-counter triplet for Dijkstra on
     the canonical grid_4x4_obstacle scenario. With h=0,
     Dijkstra pops every state it pushes — same totals as
     BFS on this unit-cost grid.
    ========================================================================
    """
