...
| `recorder` | `Recorder` | Recorded events (from algorithm execution) |
| `is_valid` | `bool` | Whether solution is valid (inherited); `bool(solution)` works |

## Usage Examples

```python
from old_f_cs.solution import SolutionAlgo
from old_f_cs.problem import ProblemAlgo
from old_f_cs.stats import StatsAlgo
